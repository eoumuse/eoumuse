      ...
      <div style={{ padding: '10px 12px', display: 'flex', flexDirection: 'column', gap: '10px' }}>
        ...
        <button
          ...
          style={{
            ...
            border: `1px solid ${enabled ? '#FFB37C' : 'rgba(245,240,230,0.15)'}`,
            background: enabled ? 'rgba(255, 230, 41, 0.12)' : 'rgba(245,240,230,0.04)',
            color: enabled ? '#FFB37C' : 'rgba(245,240,230,0.35)',
        ...
        <div style={{
          ...
          <div style={{
            fontSize: '8px', fontWeight: 700, color: '#FFB37C',
            ...
            {CHORD_MODE_KEYS.map((mode) => (
              <button
                ...
                style={{
                  ...
                  border: `1px solid ${chordMode === mode ? '#FFB37C' : 'rgba(245,240,230,0.1)'}`,
                  background: chordMode === mode ? 'rgba(255,230,41,0.18)' : 'rgba(245,240,230,0.03)',
                  color: chordMode === mode ? '#FFB37C' : 'rgba(245,240,230,0.35)',
        ...
        {detectedKey ? (
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                fontSize: '11px', fontWeight: 800, color: '#FFB37C',
                letterSpacing: '0.1em', textShadow: '0 0 10px #FFB37C',
              }}>
                {detectedKey}
              </div>
            ...
            <div style={{ height: '3px', borderRadius: '2px', background: 'rgba(245,240,230,0.08)', overflow: 'hidden' }}>
              <div style={{
                height: '100%', width: `${confPct}%`,
                background: 'linear-gradient(90deg, #FFB37C, #9098AC)',
                boxShadow: '0 0 6px #FFB37C', transition: 'width 0.5s ease',
              }} />
            </div>
          </div>
        ) : (
          <div style={{
            background: 'rgba(0,0,0,0.2)', border: '1px solid rgba(245,240,230,0.06)',
            borderRadius: '10px', padding: '8px 10px', textAlign: 'center',
            fontSize: '8px', color: 'rgba(245,240,230,0.2)', letterSpacing: '0.1em',
          }}>
