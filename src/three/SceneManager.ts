...
export class SceneManager {
  ...
  constructor(canvas: HTMLCanvasElement) {
    ...
    this.scene.background = new THREE.Color(0x1c2027)
    this.scene.fog = new THREE.FogExp2(0x1c2027, 0.04)
    ...
    // Lights
    const ambient = new THREE.AmbientLight(0x4a5568, 2.5)
    this.scene.add(ambient)

    const dir = new THREE.DirectionalLight(0xff9ac8, 0.8)
    dir.position.set(5, 5, 5)
    this.scene.add(dir)

    const dir2 = new THREE.DirectionalLight(0xffb37c, 0.4)
