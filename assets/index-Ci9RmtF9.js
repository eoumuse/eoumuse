...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ko(e,t,n){let r=new Float32Array(Mo),i=new W(0,1,0);return new pa({name:`SphericalGaussianBlur`,defines:{n:Mo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Yo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function qo(){return new pa({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Yo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Jo(){return new pa({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Yo(),fragmentShader:`
	...
	`}var Xo=class extends bn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Qi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var xc={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Sc(e,t){let n=xc[t];return n===void 0?(B(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Cc=new W;function wc(){return K.getLuminanceCoefficients(Cc),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Cc.x.toFixed(4)}, ${Cc.y.toFixed(4)}, ${Cc.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`;function au(e,t,n,r){let i=10*(t-e),a=e*(28-n)-t,o=e*t-2.6666666666666665*n;return{x:e+i*r,y:t+a*r,z:n+o*r}}var ou=class{points;material;constructor(e=5e3){let t=new Float32Array(e*3),n=new Float32Array(e),r=new Float32Array(e*3),i=.1,a=0,o=0;for(let e=0;e<200;e++){let e=au(i,a,o,.005);i=e.x,a=e.y,o=e.z}let s=[],c=[],l=[];for(let t=0;t<e;t++){let e=au(i,a,o,.005);i=e.x,a=e.y,o=e.z,s.push(i),c.push(a),l.push(o)}let u=Math.min(...s),d=Math.max(...s),f=Math.min(...c),p=Math.max(...c),m=Math.min(...l),h=Math.max(...l),g=[new q(16723355),new q(16770601),new q(12632268),new q(16723355)];for(let i=0;i<e;i++){let a=((s[i]-u)/(d-u)-.5)*4*2,o=((c[i]-f)/(p-f)-.5)*4,_=((l[i]-m)/(h-m)-.5)*4*1.5;t[i*3]=a,t[i*3+1]=o,t[i*3+2]=_,n[i]=.08+i/e*.18;let v=i/e*3,y=Math.floor(v),b=v-y,x=g[Math.min(y,g.length-1)],S=g[Math.min(y+1,g.length-1)],C=x.clone().lerp(S,b);r[i*3]=C.r,r[i*3+1]=C.g,r[i*3+2]=C.b}let _=new ei;_.setAttribute(`position`,new zr(t,3)),_.setAttribute(`alpha`,new zr(n,1)),_.setAttribute(`color`,new zr(r,3)),this.material=new pa({vertexShader:ru,fragmentShader:iu,transparent:!0,blending:2,depthWrite:!1}),this.points=new Xi(_,this.material)}update(e){this.points.rotation.y=e*3e-4,this.points.rotation.x=Math.sin(e*1e-4)*.05}dispose(){this.points.geometry.dispose(),this.material.dispose()}},su=class{lineGeom;linePosAttr;lineColorAttr;line;glowGeom;glowPosAttr;glowColorAttr;glowPoints;headMesh;headLight;scaleMap={lorenz:.12,rossler:.22,thomas:.55};constructor(e,t){this.lineGeom=new ei;let n=new Float32Array(t*3),r=new Float32Array(t*3);this.linePosAttr=new zr(n,3),this.lineColorAttr=new zr(r,3),this.lineGeom.setAttribute(`position`,this.linePosAttr),this.lineGeom.setAttribute(`color`,this.lineColorAttr),this.lineGeom.setDrawRange(0,0);let i=new Fi({vertexColors:!0,blending:2,depthWrite:!1,transparent:!0,opacity:.7});this.line=new Ui(this.lineGeom,i),e.add(this.line);let a=Math.ceil(t/4);this.glowGeom=new ei;let o=new Float32Array(a*3),s=new Float32Array(a*3);this.glowPosAttr=new zr(o,3),this.glowColorAttr=new zr(s,3),this.glowGeom.setAttribute(`position`,this.glowPosAttr),this.glowGeom.setAttribute(`color`,this.glowColorAttr),this.glowGeom.setDrawRange(0,0);let c=new Gi({size:.06,vertexColors:!0,blending:2,depthWrite:!1,transparent:!0,opacity:.55,sizeAttenuation:!0});this.glowPoints=new Xi(this.glowGeom,c),e.add(this.glowPoints);let l=new ia(.08,12,12),u=new di({color:16767040,blending:2,depthWrite:!1,transparent:!0,opacity:.95});this.headMesh=new Ci(l,u),e.add(this.headMesh),this.headLight=new Ja(16767040,2,2),e.add(this.headLight)}update(e){let t=e.trail,n=e.trailLength,r=e.trailHead,i=e.trailFilled,a=i?n:r,o=this.scaleMap[e.params.type]??.12;if(a===0)return;let s=this.linePosAttr.array,c=this.lineColorAttr.array,l=this.glowPosAttr.array,u=this.glowColorAttr.array,d=0;for(let e=0;e<a;e++){let f=e/a,p=i?(r+e)%n*3:e*3,m=t[p]*o,h=t[p+1]*o,g=t[p+2]*o;s[e*3]=m,s[e*3+1]=h,s[e*3+2]=g;let _,v,y;if(f<.6){let e=f/.6;_=.45+e*.37,v=.28+e*.29,y=.04+e*.08}else{let e=(f-.6)/.4;_=.82+e*.18,v=.57+e*.3,y=.12+e*.1}let b=Math.min(1,f*4);c[e*3]=_*b,c[e*3+1]=v*b,c[e*3+2]=y*b,e%4==0&&(l[d*3]=m,l[d*3+1]=h,l[d*3+2]=g,u[d*3]=c[e*3],u[d*3+1]=c[e*3+1],u[d*3+2]=c[e*3+2],d++)}this.linePosAttr.needsUpdate=!0,this.lineColorAttr.needsUpdate=!0,this.lineGeom.setDrawRange(0,a),this.glowPosAttr.needsUpdate=!0,this.glowColorAttr.needsUpdate=!0,this.glowGeom.setDrawRange(0,d);let f=i?(r-1+n)%n*3:(r-1)*3;if(f>=0){let e=t[f]*o,n=t[f+1]*o,r=t[f+2]*o;this.headMesh.position.set(e,n,r),this.headLight.position.set(e,n,r)}}dispose(e){e.remove(this.line),e.remove(this.glowPoints),e.remove(this.headMesh),e.remove(this.headLight),this.lineGeom.dispose(),this.glowGeom.dispose()}},cu=`
...
`,uu=class{points=null;geometry=null;material;currentNodes=[];constructor(){this.material=new pa({vertexShader:cu,fragmentShader:lu,transparent:!0,blending:2,depthWrite:!1})}updateNodes(e,t,n){if(e===this.currentNodes&&this.points){this.updateCurrentHighlight(n);return}if(this.points&&(t.remove(this.points),this.geometry?.dispose(),this.points=null,this.geometry=null),e.length===0)return;this.currentNodes=e,this.geometry=new ei;let r=new Float32Array(e.length*3),i=new Float32Array(e.length),a=new Float32Array(e.length*3),o=new q(16770601),s=new q(16777215),c=new q(16723355);for(let t=0;t<e.length;t++){let l=e[t];r[t*3]=l.x,r[t*3+1]=l.y,r[t*3+2]=l.z,i[t]=.05+l.energy*.15;let u=t===n?c:l.energy>.7?s:o;a[t*3]=u.r,a[t*3+1]=u.g,a[t*3+2]=u.b}this.geometry.setAttribute(`position`,new zr(r,3)),this.geometry.setAttribute(`size`,new zr(i,1)),this.geometry.setAttribute(`color`,new zr(a,3)),this.points=new Xi(this.geometry,this.material),t.add(this.points)}updateCurrentHighlight(e){if(!this.geometry||this.currentNodes.length===0)return;let t=this.geometry.getAttribute(`color`),n=this.geometry.getAttribute(`size`),r=new q(16770601),i=new q(16777215),a=new q(16723355);for(let o=0;o<this.currentNodes.length;o++){let s=this.currentNodes[o],c=o===e?a:s.energy>.7?i:r;t.setXYZ(o,c.r,c.g,c.b),n.setX(o,o===e?.2:.05+s.energy*.15)}t.needsUpdate=!0,n.needsUpdate=!0}dispose(){this.geometry?.dispose(),this.material.dispose()}},du=class{group;mesh;light;targetPos=new W(0,0,0);constructor(){this.group=new Zn;let e=new ia(.12,32,32),t=new ha({color:16723355,emissive:16723355,emissiveIntensity:3,roughness:.1,metalness:.8});this.mesh=new Ci(e,t),this.group.add(this.mesh);let n=new Ci(new ia(.06,16,16),new di({color:16777215,transparent:!0,opacity:.9}));this.group.add(n);let r=new Ci(new ia(.22,16,16),new di({color:16723355,transparent:!0,opacity:.1,side:1}));this.group.add(r),this.light=new Ja(16723355,4,3),this.group.add(this.light)}setTargetFromNode(e){e&&this.targetPos.set(e.x,e.y,e.z)}setTargetPosition(e,t,n){this.targetPos.set(e,t,n)}update(e){this.group.position.lerp(this.targetPos,.03);let t=1+Math.sin(e*.003)*.12;this.mesh.scale.setScalar(t),this.light.intensity=3+Math.sin(e*.004)*1.5;let n=e*1e-4%1,r=new q().setHSL(n*.15+.9,1,.6);this.mesh.material.emissive=r,this.light.color=r}dispose(){this.mesh.geometry.dispose(),this.mesh.material.dispose()}},fu={lorenz:{type:`lorenz`,p1:10,p2:28,p3:2.667,speed:1},rossler:{type:`rossler`,p1:.2,p2:.2,p3:5.7,speed:1},thomas:{type:`thomas`,p1:.19,p2:0,p3:0,speed:1}},pu={lorenz:{x:[-20,20],y:[-28,28],z:[0,50]},rossler:{x:[-12,12],y:[-12,12],z:[0,25]},thomas:{x:[-5,5],y:[-5,5],z:[-5,5]}};function mu(e,t,n,r,i){let{p1:a,p2:o,p3:s}=r,c=a*(t-e),l=e*(o-n)-t,u=e*t-s*n;return{x:e+c*i,y:t+l*i,z:n+u*i}}function hu(e,t,n,r,i){let{p1:a,p2:o,p3:s}=r,c=-t-n,l=e+a*t,u=o+n*(e-s);return{x:e+c*i,y:t+l*i,z:n+u*i}}function gu(e,t,n,r,i){let{p1:a}=r,o=Math.sin(t)-a*e,s=Math.sin(n)-a*t,c=Math.sin(e)-a*n;return{x:e+o*i,y:t+s*i,z:n+c*i}}function _u(e,t,n){return Math.max(0,Math.min(1,(e-t)/(n-t)))}var vu=24,yu=class{params;state={x:.1,y:0,z:0,nx:.5,ny:.5,nz:.5,vortexPitch:0,totalOrbits:0};semitonesPerOrbit=7;pitchWrap=!0;_prevAngle=0;_cumulativeAngle=0;trail;trailLength=6e3;trailHead=0;trailFilled=!1;constructor(e=`lorenz`){this.params={...fu[e]},this.trail=new Float32Array(this.trailLength*3),this._warmup(2e3)}setType(e){this.params={...fu[e]};let t=e===`lorenz`||e===`rossler`?{x:.1,y:0,z:0}:{x:.1,y:.1,z:0};this.state={...t,nx:.5,ny:.5,nz:.5,vortexPitch:0,totalOrbits:0},this._prevAngle=0,this._cumulativeAngle=0,this.trailHead=0,this.trailFilled=!1,this._warmup(2e3)}_warmup(e){let{x:t,y:n,z:r}=this.state;for(let i=0;i<e;i++){let e=this._step(t,n,r,.005);t=e.x,n=e.y,r=e.z}this._prevAngle=Math.atan2(n,t),this._cumulativeAngle=0,this._setState(t,n,r)}_step(e,t,n,r){switch(this.params.type){case`lorenz`:return mu(e,t,n,this.params,r);case`rossler`:return hu(e,t,n,this.params,r);case`thomas`:return gu(e,t,n,this.params,r)}}_setState(e,t,n){let r=pu[this.params.type],i=Math.atan2(t,e),a=i-this._prevAngle;a>Math.PI&&(a-=2*Math.PI),a<-Math.PI&&(a+=2*Math.PI),this._cumulativeAngle+=a,this._prevAngle=i;let o=this._cumulativeAngle/(2*Math.PI),s=o*this.semitonesPerOrbit,c=vu*2,l;l=this.pitchWrap?(s%c+c)%c-vu:Math.max(-24,Math.min(vu,s)),this.state={x:e,y:t,z:n,nx:_u(e,r.x[0],r.x[1]),ny:_u(t,r.y[0],r.y[1]),nz:_u(n,r.z[0],r.z[1]),vortexPitch:l,totalOrbits:o}}tick(e){let t=.5*this.params.speed,n=Math.max(1,Math.round(e*t)),r=.005*this.params.speed,{x:i,y:a,z:o}=this.state;for(let e=0;e<n;e++){let e=this._step(i,a,o,r);i=e.x,a=e.y,o=e.z;let t=this.trailHead*3;this.trail[t]=i,this.trail[t+1]=a,this.trail[t+2]=o,this.trailHead=(this.trailHead+1)%this.trailLength,this.trailHead===0&&(this.trailFilled=!0)}this._setState(i,a,o)}getDefaultParams(e){return{...fu[e]}}scaleForType(){return{lorenz:.12,rossler:.22,thomas:.55}[this.params.type]??.12}},bu={lorenz:{p1:{label:`σ sigma`,min:1,max:20,default:10},p2:{label:`ρ rho`,min:1,max:50,default:28},p3:{label:`β beta`,min:.5,max:6,default:2.667}},rossler:{p1:{label:`a`,min:.01,max:.5,default:.2},p2:{label:`b`,min:.01,max:.5,default:.2},p3:{label:`c`,min:1,max:15,default:5.7}},thomas:{p1:{label:`b damp`,min:.1,max:.5,default:.19},p2:{label:`—`,min:0,max:1,default:0},p3:{label:`—`,min:0,max:1,default:0}}},xu={Unison:[0],"3rd":[0,4],"5th":[0,7],Triad:[0,4,7],"7th":[0,4,7,11],Power:[0,7,12],Octave:[0,12]},Su=new class{ctx=null;buffer=null;masterGainNode=null;voices=[];enabled=!1;rootSemitone=0;chordMode=`Triad`;voiceGain=.35;detune=8;constructor(e,t){e&&t&&(this.ctx=e,this.masterGainNode=t,this.rebuildVoices())}init(e,t){this.ctx=e,this.masterGainNode=t,this.rebuildVoices()}rebuildVoices(){let e=(xu[this.chordMode]??[0,4,7]).slice(1),t=this.ctx?this.ctx.currentTime:0;this.voices=e.map(e=>({pitchOffsetSemitones:e,nextGrainTime:t+.05}))}setBuffer(e){this.buffer=e}setChordMode(e){this.chordMode=e,this.rebuildVoices()}setVoiceGain(e){this.voiceGain=e}setDetune(e){this.detune=e}tick(e,t,n,r,i){if(!this.enabled||!this.buffer||!this.ctx||!this.masterGainNode)return;let a=n/1e3,o=this.buffer.duration;for(let n of this.voices){let s=t+n.pitchOffsetSemitones+this.rootSemitone,c=(Math.random()-.5)*this.detune*2,l=2**(s/12)*2**(c/1200);for(n.nextGrainTime<this.ctx.currentTime&&(n.nextGrainTime=this.ctx.currentTime+.01);n.nextGrainTime<this.ctx.currentTime+.1;){let t=this.ctx.createBufferSource();t.buffer=this.buffer,t.playbackRate.value=l;let s=i*o*.1,c=e*o+(Math.random()-.5)*s,u=Math.min(a,o*.5),d=Math.max(0,Math.min(c,o-u-.001)),f=u;t.start(n.nextGrainTime,d,f);let p=this.ctx.createGain();p.gain.setValueAtTime(0,n.nextGrainTime),p.gain.linearRampToValueAtTime(this.voiceGain,n.nextGrainTime+f*.3),p.gain.linearRampToValueAtTime(0,n.nextGrainTime+f),t.connect(p),p.connect(this.masterGainNode);let m=1/Math.max(r,.5),h=(Math.random()-.5)*.01;n.nextGrainTime+=m+h}}}start(){this.rebuildVoices()}stop(){}},Cu=new class{ctx;buffer=null;masterGainNode;grainSize=150;density=8;pitch=0;position=.5;scatter=.2;panSpread=.4;masterGain=.7;filterNode;delayNode;delayFeedbackNode;delayWetNode;reverbNode;reverbWetNode;fxInputGain;filterType=`lowpass`;filterCutoff=8e3;filterResonance=1;delayTime=.25;delayFeedback=.3;delayWet=0;reverbWet=0;nextGrainTime=0;intervalId=null;_isStarted=!1;mediaStreamDest;mediaRecorder=null;recordedChunks=[];createImpulseResponse(e=2.5,t=2){let n=this.ctx.sampleRate,r=Math.floor(n*e),i=this.ctx.createBuffer(2,r,n);for(let e=0;e<2;e++){let n=i.getChannelData(e);for(let e=0;e<r;e++)n[e]=(Math.random()*2-1)*(1-e/r)**t}return i}ensureContext(){this.ctx||(this.ctx=new AudioContext,this.masterGainNode=this.ctx.createGain(),this.masterGainNode.gain.value=this.masterGain,this.masterGainNode.connect(this.ctx.destination),this.fxInputGain=this.ctx.createGain(),this.fxInputGain.gain.value=1,this.filterNode=this.ctx.createBiquadFilter(),this.filterNode.type=this.filterType,this.filterNode.frequency.value=this.filterCutoff,this.filterNode.Q.value=this.filterResonance,this.delayNode=this.ctx.createDelay(2),this.delayNode.delayTime.value=this.delayTime,this.delayFeedbackNode=this.ctx.createGain(),this.delayFeedbackNode.gain.value=this.delayFeedback,this.delayWetNode=this.ctx.createGain(),this.delayWetNode.gain.value=this.delayWet,this.reverbNode=this.ctx.createConvolver(),this.reverbNode.buffer=this.createImpulseResponse(),this.reverbWetNode=this.ctx.createGain(),this.reverbWetNode.gain.value=this.reverbWet,this.fxInputGain.connect(this.masterGainNode),this.fxInputGain.connect(this.filterNode),this.filterNode.connect(this.masterGainNode),this.filterNode.connect(this.delayNode),this.delayNode.connect(this.delayFeedbackNode),this.delayFeedbackNode.connect(this.delayNode),this.delayNode.connect(this.delayWetNode),this.delayWetNode.connect(this.masterGainNode),this.filterNode.connect(this.reverbNode),this.reverbNode.connect(this.reverbWetNode),this.reverbWetNode.connect(this.masterGainNode),this.mediaStreamDest=this.ctx.createMediaStreamDestination(),this.masterGainNode.connect(this.mediaStreamDest),Su.init(this.ctx,this.masterGainNode))}startRecording(){if(!this.mediaStreamDest)return;this.recordedChunks=[];let e=MediaRecorder.isTypeSupported(`audio/webm;codecs=opus`)?`audio/webm;codecs=opus`:`audio/webm`;this.mediaRecorder=new MediaRecorder(this.mediaStreamDest.stream,{mimeType:e}),this.mediaRecorder.ondataavailable=e=>{e.data.size>0&&this.recordedChunks.push(e.data)},this.mediaRecorder.start(100)}stopRecording(){this.mediaRecorder&&=(this.mediaRecorder.onstop=()=>{let e=new Blob(this.recordedChunks,{type:`audio/webm`}),t=URL.createObjectURL(e),n=document.createElement(`a`);n.href=t,n.download=`grainweaver-${new Date().toISOString().slice(0,19).replace(/:/g,`-`)}.webm`,document.body.appendChild(n),n.click(),document.body.removeChild(n),URL.revokeObjectURL(t)},this.mediaRecorder.stop(),null)}setFilterCutoff(e){this.filterCutoff=e,this.filterNode&&this.filterNode.frequency.setTargetAtTime(e,this.ctx.currentTime,.01)}setFilterResonance(e){this.filterResonance=e,this.filterNode&&this.filterNode.Q.setTargetAtTime(e,this.ctx.currentTime,.01)}setFilterType(e){this.filterType=e,this.filterNode&&(this.filterNode.type=e)}setDelayTime(e){this.delayTime=e,this.delayNode&&this.delayNode.delayTime.setTargetAtTime(e,this.ctx.currentTime,.01)}setDelayFeedback(e){this.delayFeedback=e,this.delayFeedbackNode&&this.delayFeedbackNode.gain.setTargetAtTime(e,this.ctx.currentTime,.01)}setDelayWet(e){this.delayWet=e,this.delayWetNode&&this.delayWetNode.gain.setTargetAtTime(e,this.ctx.currentTime,.01)}setReverbWet(e){this.reverbWet=e,this.reverbWetNode&&this.reverbWetNode.gain.setTargetAtTime(e,this.ctx.currentTime,.01)}async loadFile(e){this.ensureContext(),this.ctx.state===`suspended`&&await this.ctx.resume();let t=await e.arrayBuffer();this.buffer=await this.ctx.decodeAudioData(t)}start(){this._isStarted||(this.ensureContext(),this.ctx.state===`suspended`&&this.ctx.resume(),this._isStarted=!0,this.nextGrainTime=this.ctx.currentTime+.05,this.intervalId=setInterval(()=>this.scheduleGrains(),25))}stop(){this._isStarted&&(this._isStarted=!1,this.intervalId!==null&&(clearInterval(this.intervalId),this.intervalId=null))}setMasterGain(e){this.masterGain=e,this.masterGainNode&&this.masterGainNode.gain.setTargetAtTime(e,this.ctx.currentTime,.01)}scheduleGrains(){if(!this.buffer||!this._isStarted)return;Su.tick(this.position,this.pitch,this.grainSize,this.density,this.scatter);let e=this.grainSize/1e3,t=this.buffer.duration;for(;this.nextGrainTime<this.ctx.currentTime+.1;){let n=this.ctx.createBufferSource();n.buffer=this.buffer,n.playbackRate.value=2**(this.pitch/12);let r=this.scatter*t*.1,i=this.position*t+(Math.random()-.5)*r,a=Math.min(e,t*.5),o=Math.max(0,Math.min(i,t-a-.001)),s=a;n.start(this.nextGrainTime,o,s);let c=this.ctx.createGain();c.gain.setValueAtTime(0,this.nextGrainTime),c.gain.linearRampToValueAtTime(1,this.nextGrainTime+s*.3),c.gain.linearRampToValueAtTime(0,this.nextGrainTime+s);let l=this.ctx.createStereoPanner();l.pan.value=(Math.random()-.5)*this.panSpread*2,n.connect(c),c.connect(l),l.connect(this.fxInputGain);let u=1/Math.max(this.density,.5),d=(Math.random()-.5)*.01;this.nextGrainTime+=u+d}}},wu=o((e=>{var t=Symbol.for(`react.transitional.element`);function n(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.jsx=n,e.jsxs=n})),$=o(((e,t)=>{t.exports=wu()}))();function Tu(){let e=(0,_.useRef)(null),t=(0,_.useRef)(null),n=(0,_.useRef)(null),r=(0,_.useRef)(null),i=(0,_.useRef)(null),a=(0,_.useRef)(null),o=(0,_.useRef)(null),s=(0,_.useRef)(performance.now()),c=w(e=>e.nodes),l=w(e=>e.currentNodeIndex),u=w(e=>e.isPlaying);return(0,_.useEffect)(()=>{let c=e.current;if(!c)return;let l=new nu(c);t.current=l;let u=new ou(2e3);l.scene.add(u.points),n.current=u;let d=new yu(`lorenz`);o.current=d;let f=new su(l.scene,d.trailLength);r.current=f;let p=new uu;i.current=p;let m=new du;l.scene.add(m.group),a.current=m,l.startAnimation(e=>{let t=performance.now(),n=Math.min(t-s.current,50);s.current=t;let r=o.current;if(r){let e=w.getState();r.params.type!==e.attractorType&&r.setType(e.attractorType),r.params.p1=e.attractorP1,r.params.p2=e.attractorP2,r.params.p3=e.attractorP3,r.params.speed=e.attractorSpeed,r.tick(n),e.setAttractorState(r.state.nx,r.state.ny,r.state.nz,r.state.vortexPitch),e.attractorLinked&&e.isPlaying&&(Cu.position=r.state.nx,Cu.pitch=r.state.vortexPitch,Cu.grainSize=10+r.state.nz*1990),r.semitonesPerOrbit=e.semitonesPerOrbit,r.pitchWrap=e.pitchWrap;let t=r.scaleForType();m.setTargetPosition(r.state.x*t,r.state.y*t,r.state.z*t),f.update(r)}u.update(e),m.update(e)});let h=()=>l.resize(c.clientWidth,c.clientHeight);return window.addEventListener(`resize`,h),()=>{window.removeEventListener(`resize`,h),l.dispose(),u.dispose(),p.dispose(),m.dispose()}},[]),(0,_.useEffect)(()=>{let e=t.current,n=i.current;!e||!n||n.updateNodes(c,e.scene,l)},[c,l]),(0,_.useEffect)(()=>{let e=w.getState();if(!u||c.length===0||e.attractorLinked)return;let t=setInterval(()=>{let e=w.getState();if(e.attractorLinked)return;let t=(e.currentNodeIndex+1)%c.length;e.setCurrentNode(t);let n=c[t];n&&Cu.buffer&&(Cu.position=n.time/Cu.buffer.duration)},700);return()=>clearInterval(t)},[u,c]),(0,$.jsx)(`canvas`,{ref:e,style:{position:`absolute`,inset:0,width:`100%`,height:`100%`,display:`block`}})}function Eu(e,t=200){let n=e.getChannelData(0),r=e.sampleRate,i=e.duration,a=Math.floor(n.length/512),o=512*Math.max(1,Math.ceil(a/8e3)),s=Math.floor(n.length/o),c=Array(s),l=Array(s);for(let e=0;e<s;e++){let t=e*o,r=0,i=0,a=0;for(let e=0;e<o;e++){let s=n[t+e]??0;r+=s*s;let c=Math.abs(s);i+=e/o*c,a+=c}c[e]=Math.sqrt(r/o),l[e]=a>0?i/a:.5}let u=1e-6;for(let e=0;e<s;e++)c[e]>u&&(u=c[e]);let d=c.map(e=>e/u),f=Math.max(1,Math.floor(r/o*.05)),p=[];for(let e=1;e<s-1;e++)d[e]>.15&&d[e]>d[e-1]&&d[e]>=d[e+1]&&(p.length===0||e-p[p.length-1]>=f)&&p.push(e);if(p.length<10){p.length=0;let e=Math.max(1,Math.floor(s/Math.min(t,50)));for(let t=0;t<s;t+=e)p.push(t)}return(p.length>t?p.filter((e,n)=>n%Math.ceil(p.length/t)===0).slice(0,t):p).map((e,t)=>{let n=e*o/r,a=d[e]??.5,s=l[e]??.5;return{id:`node-${t}`,time:n,energy:a,centroid:s,x:n/i*4-2,y:(s-.5)*3+Math.sin(t*.7)*.5,z:(a-.5)*2+Math.cos(t*.5)*.4}})}var Du=[`C`,`C#`,`D`,`D#`,`E`,`F`,`F#`,`G`,`G#`,`A`,`A#`,`B`],Ou=[6.35,2.23,3.48,2.33,4.38,4.09,2.52,5.19,2.39,3.66,2.29,2.88],ku=[6.33,2.68,3.52,5.38,2.6,3.53,2.54,4.75,3.98,2.69,3.34,3.17];function Au(e,t){let n=e.length,r=e.reduce((e,t)=>e+t,0)/n,i=t.reduce((e,t)=>e+t,0)/n,a=0,o=0,s=0;for(let c=0;c<n;c++){let n=e[c]-r,l=t[c]-i;a+=n*l,o+=n*n,s+=l*l}let c=Math.sqrt(o*s);return c===0?0:a/c}function ju(e){let t=e.length,n=new Float32Array(t);for(let r=0;r<e.numberOfChannels;r++){let i=e.getChannelData(r);for(let r=0;r<t;r++)n[r]+=i[r]/e.numberOfChannels}let r=e.sampleRate,i=2048,a=Array(12).fill(0),o=Math.floor((t-i)/512),s=440*2**-4.75;for(let e=0;e<o;e++){let t=e*512;for(let e=0;e<12;e++){let o=0;for(let a=2;a<=6;a++){let c=s*2**(a+e/12);if(c>r/2)continue;let l=2*Math.PI*c/r,u=2*Math.cos(l),d=0,f=0;for(let e=0;e<i;e++){let r=n[t+e]??0,a=.5*(1-Math.cos(2*Math.PI*e/(i-1))),o=u*d-f+r*a;f=d,d=o}let p=d*d+f*f-d*f*u;o+=Math.max(0,p)}a[e]+=o}}let c=Math.max(...a),l=c>0?a.map(e=>e/c):a,u=-1/0,d=0,f=`major`,p=[];for(let e=0;e<12;e++){let t=Array.from({length:12},(t,n)=>l[(n+e)%12]),n=Au(t,Ou),r=Au(t,ku);p.push(n,r),n>u&&(u=n,d=e,f=`major`),r>u&&(u=r,d=e,f=`minor`)}let m=Math.min(...p),h=Math.max(...p),g=h>m?(u-m)/(h-m):.5,_=f===`major`?`Major`:`Minor`;return{root:d,mode:f,confidence:Math.max(0,Math.min(1,g)),name:`${Du[d]} ${_}`}}function Mu(){let[e,t]=(0,_.useState)(!1),[n,r]=(0,_.useState)(!1),i=(0,_.useRef)(null),a=(0,_.useRef)(null),o=w(e=>e.setNodes),s=w(e=>e.setAudioLoaded),c=w(e=>e.setDetectedKey),l=w(e=>e.fileName),u=w(e=>e.audioLoaded),d=(0,_.useCallback)(e=>{let t=i.current;if(!t)return;let n=t.getContext(`2d`);if(!n)return;let r=e.getChannelData(0),{width:a,height:o}=t,s=Math.ceil(r.length/a),c=o/2;n.clearRect(0,0,a,o),n.fillStyle=`rgba(0,0,0,0)`,n.fillRect(0,0,a,o),n.beginPath(),n.strokeStyle=`#888899`,n.lineWidth=1;for(let e=0;e<a;e++){let t=1,i=-1;for(let n=0;n<s;n++){let a=r[e*s+n]??0;a<t&&(t=a),a>i&&(i=a)}let a=e,o=(1+t)*c,l=(1+i)*c;e===0?n.moveTo(a,o):(n.lineTo(a,o),n.lineTo(a,l))}n.stroke(),n.beginPath(),n.strokeStyle=`#FF2D9B`,n.lineWidth=.5,n.globalAlpha=.5;for(let e=0;e<a;e++){let t=0;for(let n=0;n<s;n++)t+=Math.abs(r[e*s+n]??0);let i=(1-t/s)*c;e===0?n.moveTo(e,i):n.lineTo(e,i)}n.stroke(),n.globalAlpha=1},[]),f=(0,_.useCallback)(async e=>{if(!(!e.type.startsWith(`audio/`)&&!e.name.match(/\.(wav|mp3|ogg|flac|aiff|m4a)$/i))){r(!0);try{await Cu.loadFile(e);let t=Cu.buffer;o(Eu(t,200)),s(!0,e.name),Su.setBuffer(t);try{let e=ju(t);c(e.name,e.confidence)}catch(e){console.warn(`Key detection failed:`,e)}d(t)}catch(e){console.error(`Failed to load audio:`,e)}finally{r(!1)}}},[o,s,c,d]),p=(0,_.useCallback)(e=>{e.preventDefault(),t(!1);let n=e.dataTransfer.files[0];n&&f(n)},[f]),m=(0,_.useCallback)(e=>{e.preventDefault(),t(!0)},[]),h=(0,_.useCallback)(()=>{t(!1)},[]),g=(0,_.useCallback)(e=>{let t=e.target.files?.[0];t&&f(t)},[f]);return(0,$.jsxs)(`div`,{className:`panel`,style:{width:`100%`},children:[(0,$.jsxs)(`div`,{className:`panel-header`,children:[(0,$.jsx)(`span`,{className:`sparkle`,children:`✦`}),` SAMPLE LOADER `,(0,$.jsx)(`span`,{className:`sparkle`,style:{animationDelay:`0.5s`},children:`✧`})]}),(0,$.jsxs)(`div`,{style:{padding:`12px`},children:[(0,$.jsx)(`div`,{onDrop:p,onDragOver:m,onDragLeave:h,onClick:()=>a.current?.click(),style:{border:e?`2px dashed #FF2D9B`:`2px dashed rgba(136, 136, 153, 0.4)`,borderRadius:`12px`,padding:`16px 12px`,textAlign:`center`,cursor:`pointer`,transition:`all 0.2s`,background:e?`rgba(255, 45, 155, 0.05)`:`transparent`,boxShadow:e?`0 0 20px #FF2D9B44`:`none`},children:n?(0,$.jsxs)(`div`,{style:{color:`#888899`,fontSize:`12px`},children:[(0,$.jsx)(`div`,{className:`sparkle`,style:{fontSize:`20px`,marginBottom:`4px`},children:`★`}),`ANALYZING...`]}):u?(0,$.jsxs)(`div`,{style:{color:`#FFE629`,fontSize:`11px`},children:[(0,$.jsx)(`div`,{style:{color:`#FFE629`,marginBottom:`4px`,fontSize:`10px`},children:`✦ LOADED ✦`}),(0,$.jsx)(`div`,{style:{overflow:`hidden`,textOverflow:`ellipsis`,whiteSpace:`nowrap`,maxWidth:`200px`,margin:`0 auto`},children:l})]}):(0,$.jsxs)(`div`,{style:{color:`rgba(136, 136, 153, 0.7)`,fontSize:`11px`},children:[(0,$.jsx)(`div`,{className:`float`,style:{fontSize:`18px`,marginBottom:`6px`,color:`#FF2D9B`},children:`✦`}),(0,$.jsx)(`div`,{style:{fontWeight:`700`,letterSpacing:`0.1em`,color:`#FFF0FF`},children:`DROP SAMPLE`}),(0,$.jsx)(`div`,{style:{fontSize:`10px`,marginTop:`2px`,color:`rgba(136, 136, 153, 0.5)`},children:`or click to browse`})]})}),u&&(0,$.jsx)(`canvas`,{ref:i,width:220,height:40,style:{width:`100%`,height:`40px`,marginTop:`8px`,borderRadius:`6px`,background:`rgba(0,0,0,0.3)`}}),(0,$.jsx)(`input`,{ref:a,type:`file`,accept:`audio/*`,style:{display:`none`},onChange:g})]})]})}var Nu=56,Pu=5,Fu=(Nu-Pu)/2-2,Iu=Nu/2,Lu=135,Ru=270;function zu(e,t){let n=(e-90)*(Math.PI/180);return{x:Iu+t*Math.cos(n),y:Iu+t*Math.sin(n)}}function Bu(e,t,n){let r=zu(e,n),i=zu(t,n),a=+(t-e>180);return`M ${r.x} ${r.y} A ${n} ${n} 0 ${a} 1 ${i.x} ${i.y}`}function Vu({value:e,min:t,max:n,label:r,color:i,onChange:a,defaultValue:o,formatValue:s}){let c=(0,_.useRef)(null),[l,u]=(0,_.useState)(!1),d=(e-t)/(n-t),f=Lu+d*Ru,p=Lu,m=Bu(p,405,Fu),h=d>0?Bu(p,f,Fu):``,g=zu(f,Fu),v=(0,_.useCallback)(t=>{t.preventDefault(),c.current={startY:t.clientY,startValue:e},u(!0)},[e]),y=(0,_.useCallback)(()=>{a(o)},[a,o]);(0,_.useEffect)(()=>{if(!l)return;let e=e=>{if(!c.current)return;let r=c.current.startY-e.clientY,i=n-t,o=r/150*i;a(Math.min(n,Math.max(t,c.current.startValue+o)))},r=()=>{c.current=null,u(!1)};return window.addEventListener(`mousemove`,e),window.addEventListener(`mouseup`,r),()=>{window.removeEventListener(`mousemove`,e),window.removeEventListener(`mouseup`,r)}},[l,t,n,a]);let b=s?s(e):e.toFixed(1);return(0,$.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,alignItems:`center`,gap:`4px`,userSelect:`none`},children:[(0,$.jsxs)(`svg`,{width:Nu,height:Nu,onMouseDown:v,onDoubleClick:y,style:{cursor:`ns-resize`,filter:l?`drop-shadow(0 0 8px ${i})`:`drop-shadow(0 0 4px ${i}66)`,transition:`filter 0.1s`},children:[(0,$.jsx)(`path`,{d:m,fill:`none`,stroke:`rgba(255,255,255,0.1)`,strokeWidth:Pu,strokeLinecap:`round`}),h&&(0,$.jsx)(`path`,{d:h,fill:`none`,stroke:i,strokeWidth:Pu,strokeLinecap:`round`,style:{filter:`drop-shadow(0 0 3px ${i})`}}),(0,$.jsx)(`circle`,{cx:Iu,cy:Iu,r:Fu*.45,fill:`rgba(10,0,20,0.8)`,stroke:`rgba(255,255,255,0.08)`,strokeWidth:1}),(0,$.jsx)(`circle`,{cx:g.x,cy:g.y,r:3,fill:i,style:{filter:`drop-shadow(0 0 4px ${i})`}})]}),(0,$.jsx)(`div`,{style:{fontSize:`9px`,fontWeight:`700`,letterSpacing:`0.12em`,color:i,textShadow:`0 0 8px ${i}`,textTransform:`uppercase`},children:r}),(0,$.jsx)(`div`,{style:{fontSize:`10px`,color:`rgba(255, 240, 255, 0.7)`,fontVariantNumeric:`tabular-nums`,minWidth:`36px`,textAlign:`center`},children:b})]})}function Hu(){let e=w(e=>e.grainSize),t=w(e=>e.density),n=w(e=>e.position),r=w(e=>e.scatter),i=w(e=>e.pitch),a=w(e=>e.panSpread),o=w(e=>e.setGrainSize),s=w(e=>e.setDensity),c=w(e=>e.setPosition),l=w(e=>e.setScatter),u=w(e=>e.setPitch),d=w(e=>e.setPanSpread),f=(0,_.useCallback)(e=>{o(e),Cu.grainSize=e},[o]),p=(0,_.useCallback)(e=>{s(e),Cu.density=e},[s]),m=(0,_.useCallback)(e=>{c(e),Cu.position=e},[c]),h=(0,_.useCallback)(e=>{l(e),Cu.scatter=e},[l]),g=(0,_.useCallback)(e=>{u(e),Cu.pitch=e},[u]),v=(0,_.useCallback)(e=>{d(e),Cu.panSpread=e},[d]);return(0,$.jsxs)(`div`,{className:`panel`,children:[(0,$.jsxs)(`div`,{className:`panel-header`,children:[(0,$.jsx)(`span`,{className:`sparkle`,children:`★`}),` GRAIN ENGINE `,(0,$.jsx)(`span`,{className:`sparkle`,style:{animationDelay:`1s`},children:`✦`})]}),(0,$.jsx)(`div`,{style:{padding:`12px`},children:(0,$.jsxs)(`div`,{style:{display:`grid`,gridTemplateColumns:`repeat(3, 1fr)`,gap:`8px`},children:[(0,$.jsx)(Vu,{value:n,min:0,max:1,label:`POS`,color:`#FF2D9B`,onChange:m,defaultValue:.5,formatValue:e=>(e*100).toFixed(0)+`%`}),(0,$.jsx)(Vu,{value:e,min:10,max:2e3,label:`GRAIN`,color:`#888899`,onChange:f,defaultValue:150,formatValue:e=>e.toFixed(0)+`ms`}),(0,$.jsx)(Vu,{value:t,min:1,max:100,label:`DENS`,color:`#FFE629`,onChange:p,defaultValue:8,formatValue:e=>e.toFixed(1)}),(0,$.jsx)(Vu,{value:i,min:-24,max:24,label:`PITCH`,color:`#FFE629`,onChange:g,defaultValue:0,formatValue:e=>(e>=0?`+`:``)+e.toFixed(1)}),(0,$.jsx)(Vu,{value:r,min:0,max:1,label:`SCATTER`,color:`#FF6B6B`,onChange:h,defaultValue:.2,formatValue:e=>(e*100).toFixed(0)+`%`}),(0,$.jsx)(Vu,{value:a,min:0,max:1,label:`PAN`,color:`#888899`,onChange:v,defaultValue:.4,formatValue:e=>(e*100).toFixed(0)+`%`})]})})]})}var Uu=[{type:`lorenz`,label:`LORENZ`,emoji:`🦋`,desc:`Butterfly chaos`},{type:`rossler`,label:`RÖSSLER`,emoji:`🌀`,desc:`Smooth vortex`},{type:`thomas`,label:`THOMAS`,emoji:`✦`,desc:`Symmetric swirl`}],Wu={lorenz:`#FF2D9B`,rossler:`#888899`,thomas:`#FFE629`};function Gu(){let e=w(e=>e.attractorType),t=w(e=>e.attractorLinked),n=w(e=>e.attractorSpeed),r=w(e=>e.attractorP1),i=w(e=>e.attractorP2),a=w(e=>e.attractorP3),o=w(e=>e.attractorNX),s=w(e=>e.attractorNZ),c=w(e=>e.attractorVortexPitch),l=w(e=>e.semitonesPerOrbit),u=w(e=>e.pitchWrap),d=w(e=>e.setAttractorType),f=w(e=>e.setAttractorLinked),p=w(e=>e.setAttractorSpeed),m=w(e=>e.setAttractorP1),h=w(e=>e.setAttractorP2),g=w(e=>e.setAttractorP3),v=w(e=>e.setSemitonesPerOrbit),y=w(e=>e.setPitchWrap),b=bu[e],x=Wu[e],S=(0,_.useCallback)(e=>{d(e);let t=bu[e];m(t.p1.default),h(t.p2.default),g(t.p3.default)},[d,m,h,g]);return(0,$.jsxs)(`div`,{className:`panel`,children:[(0,$.jsxs)(`div`,{className:`panel-header`,style:{borderColor:`${x}66`},children:[(0,$.jsx)(`span`,{className:`sparkle`,children:`⊛`}),` ATTRACTOR ENGINE`,` `,(0,$.jsx)(`span`,{style:{fontSize:`9px`,opacity:.6},children:`// chaos drives sound`})]}),(0,$.jsxs)(`div`,{style:{padding:`12px`,display:`flex`,flexDirection:`column`,gap:`10px`},children:[(0,$.jsx)(`div`,{style:{display:`flex`,gap:`6px`},children:Uu.map(({type:t,label:n,emoji:r,desc:i})=>(0,$.jsxs)(`button`,{onClick:()=>S(t),title:i,style:{flex:1,padding:`6px 4px`,borderRadius:`10px`,border:`1px solid ${e===t?Wu[t]:`rgba(255,255,255,0.12)`}`,background:e===t?`${Wu[t]}22`:`rgba(255,255,255,0.03)`,color:e===t?Wu[t]:`rgba(255,255,255,0.4)`,fontSize:`9px`,fontWeight:`700`,letterSpacing:`0.08em`,cursor:`pointer`,transition:`all 0.15s`,boxShadow:e===t?`0 0 12px ${Wu[t]}44`:`none`},children:[(0,$.jsx)(`div`,{style:{fontSize:`14px`,marginBottom:`2px`},children:r}),n]},t))}),(0,$.jsx)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`8px`},children:(0,$.jsx)(`button`,{onClick:()=>f(!t),style:{flex:1,padding:`5px 8px`,borderRadius:`8px`,border:`1px solid ${t?x:`rgba(255,255,255,0.15)`}`,background:t?`${x}18`:`rgba(255,255,255,0.04)`,color:t?x:`rgba(255,255,255,0.35)`,fontSize:`9px`,fontWeight:`700`,letterSpacing:`0.1em`,cursor:`pointer`,transition:`all 0.15s`,boxShadow:t?`0 0 10px ${x}44`:`none`},children:t?`⇌ LINKED TO AUDIO`:`⇌ LINK TO AUDIO`})}),(0,$.jsxs)(`div`,{style:{display:`grid`,gridTemplateColumns:`repeat(3, 1fr)`,gap:`4px`,background:`rgba(0,0,0,0.3)`,borderRadius:`8px`,padding:`6px`},children:[[{label:`X → POS`,val:o,norm:o,color:`#FF2D9B`},{label:`Z → GRAIN`,val:s,norm:s,color:`#FFE629`}].map(({label:e,val:t,norm:n,color:r})=>(0,$.jsxs)(`div`,{style:{textAlign:`center`},children:[(0,$.jsx)(`div`,{style:{fontSize:`8px`,color:`rgba(255,255,255,0.35)`,letterSpacing:`0.06em`,marginBottom:`2px`},children:e}),(0,$.jsx)(`div`,{style:{height:`3px`,borderRadius:`2px`,background:`rgba(255,255,255,0.08)`,overflow:`hidden`,marginBottom:`2px`},children:(0,$.jsx)(`div`,{style:{height:`100%`,width:`${n*100}%`,background:r,boxShadow:`0 0 6px ${r}`,transition:`width 0.05s`}})}),(0,$.jsx)(`div`,{style:{fontSize:`9px`,color:r,fontVariantNumeric:`tabular-nums`,textShadow:`0 0 6px ${r}`},children:t.toFixed(2)})]},e)),(0,$.jsxs)(`div`,{style:{textAlign:`center`},children:[(0,$.jsx)(`div`,{style:{fontSize:`8px`,color:`rgba(255,255,255,0.35)`,letterSpacing:`0.06em`,marginBottom:`2px`},children:`↑ VORTEX`}),(0,$.jsxs)(`div`,{style:{height:`3px`,borderRadius:`2px`,background:`rgba(255,255,255,0.08)`,overflow:`hidden`,position:`relative`,marginBottom:`2px`},children:[(0,$.jsx)(`div`,{style:{position:`absolute`,top:0,height:`100%`,width:`${Math.abs(c)/24*50}%`,left:c>=0?`50%`:`${50-Math.abs(c)/24*50}%`,background:`#FFE629`,boxShadow:`0 0 6px #FFE629`,transition:`all 0.05s`}}),(0,$.jsx)(`div`,{style:{position:`absolute`,top:0,left:`50%`,width:`1px`,height:`100%`,background:`rgba(255,255,255,0.3)`}})]}),(0,$.jsxs)(`div`,{style:{fontSize:`9px`,color:`#FFE629`,fontVariantNumeric:`tabular-nums`,textShadow:`0 0 6px #FFE629`},children:[c>=0?`+`:``,c.toFixed(1),` st`]})]})]}),(0,$.jsxs)(`div`,{style:{background:`rgba(255,230,41,0.04)`,border:`1px solid rgba(255,230,41,0.18)`,borderRadius:`10px`,padding:`8px 10px`,display:`flex`,flexDirection:`column`,gap:`8px`},children:[(0,$.jsxs)(`div`,{style:{fontSize:`8px`,color:`#FFE629`,letterSpacing:`0.12em`,fontWeight:700,opacity:.8},children:[`↑ VORTEX PITCH  `,(0,$.jsx)(`span`,{style:{opacity:.5,fontWeight:400},children:`// orbital angle → semitones`})]}),(0,$.jsxs)(`div`,{style:{display:`flex`,gap:`8px`,alignItems:`center`},children:[(0,$.jsx)(Vu,{value:l,min:1,max:24,label:`ST/ORBIT`,color:`#FFE629`,onChange:v,defaultValue:7,formatValue:e=>`+${e.toFixed(0)}`}),(0,$.jsxs)(`div`,{style:{flex:1},children:[(0,$.jsx)(`button`,{onClick:()=>y(!u),style:{width:`100%`,padding:`5px 6px`,borderRadius:`8px`,border:`1px solid ${u?`#FFE62966`:`rgba(255,255,255,0.12)`}`,background:u?`rgba(255,230,41,0.1)`:`rgba(255,255,255,0.03)`,color:u?`#FFE629`:`rgba(255,255,255,0.3)`,fontSize:`8px`,fontWeight:700,letterSpacing:`0.08em`,cursor:`pointer`,marginBottom:`4px`,display:`block`,transition:`all 0.15s`},children:u?`∞ SHEPHERD WRAP`:`⊢ CLAMP ±24st`}),(0,$.jsx)(`div`,{style:{fontSize:`7.5px`,color:`rgba(255,255,255,0.25)`,lineHeight:1.4,padding:`0 2px`},children:u?`Pitch loops endlessly upward like a sonic vortex`:`Pitch rises then freezes at ceiling`})]})]})]}),(0,$.jsxs)(`div`,{style:{display:`grid`,gridTemplateColumns:`repeat(4, 1fr)`,gap:`6px`},children:[(0,$.jsx)(Vu,{value:n,min:.1,max:4,label:`SPEED`,color:x,onChange:p,defaultValue:1,formatValue:e=>e.toFixed(2)+`×`}),(0,$.jsx)(Vu,{value:r,min:b.p1.min,max:b.p1.max,label:b.p1.label,color:x,onChange:m,defaultValue:b.p1.default,formatValue:e=>e.toFixed(2)}),e!==`thomas`&&(0,$.jsx)(Vu,{value:i,min:b.p2.min,max:b.p2.max,label:b.p2.label,color:x,onChange:h,defaultValue:b.p2.default,formatValue:e=>e.toFixed(2)}),e!==`thomas`&&(0,$.jsx)(Vu,{value:a,min:b.p3.min,max:b.p3.max,label:b.p3.label,color:x,onChange:g,defaultValue:b.p3.default,formatValue:e=>e.toFixed(2)})]}),e===`lorenz`&&(0,$.jsx)(`div`,{style:{fontSize:`9px`,color:i>24?`#FF6B6B`:`rgba(255,255,255,0.25)`,textAlign:`center`,letterSpacing:`0.06em`,transition:`color 0.3s`},children:i>24.7?`⚡ CHAOTIC REGIME — sound destabilizes`:i>20?`⚠ approaching bifurcation point (ρ≈24.7)`:`ρ < 24.7 — stable orbit`})]})]})}function Ku(){let e=w(e=>e.isPlaying),t=w(e=>e.audioLoaded),n=w(e=>e.masterGain),r=w(e=>e.setPlaying),i=w(e=>e.setMasterGain),[a,o]=(0,_.useState)(!1),s=(0,_.useCallback)(()=>{t&&(e?(Cu.stop(),r(!1)):(Cu.start(),r(!0)))},[e,t,r]),c=(0,_.useCallback)(()=>{e&&(a?(Cu.stopRecording(),o(!1)):(Cu.startRecording(),o(!0)))},[e,a]),l=(0,_.useCallback)(e=>{let t=parseFloat(e.target.value);i(t),Cu.setMasterGain(t)},[i]);return(0,$.jsx)(`div`,{className:`panel neon-glow-pink`,style:{width:`100%`},children:(0,$.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`10px`,padding:`10px 14px`},children:[(0,$.jsx)(`button`,{onClick:s,disabled:!t,style:{width:`44px`,height:`44px`,borderRadius:`50%`,border:e?`2px solid #FF2D9B`:`2px solid rgba(136,136,160,0.4)`,background:e?`radial-gradient(circle, #FF2D9B33, #323240)`:`radial-gradient(circle, #50505E55, #323240)`,cursor:t?`pointer`:`not-allowed`,display:`flex`,alignItems:`center`,justifyContent:`center`,transition:`all 0.2s`,boxShadow:e?`0 0 18px #FF2D9B66, 0 0 36px #FF2D9B33`:`none`,opacity:t?1:.4,flexShrink:0},children:e?(0,$.jsx)(`svg`,{width:`14`,height:`14`,viewBox:`0 0 14 14`,fill:`none`,children:(0,$.jsx)(`rect`,{x:`2`,y:`2`,width:`10`,height:`10`,rx:`1`,fill:`#FF2D9B`})}):(0,$.jsx)(`svg`,{width:`14`,height:`14`,viewBox:`0 0 14 14`,fill:`none`,children:(0,$.jsx)(`path`,{d:`M3 2L12 7L3 12V2Z`,fill:t?`#FFE629`:`rgba(255,230,41,0.3)`})})}),(0,$.jsxs)(`div`,{style:{flex:1},children:[(0,$.jsx)(`div`,{style:{fontSize:`10px`,fontWeight:`700`,letterSpacing:`0.12em`,color:e?`#FF2D9B`:`rgba(136,136,160,0.7)`,textShadow:e?`0 0 10px #FF2D9B`:`none`,textTransform:`uppercase`},children:e?(0,$.jsx)(`span`,{className:`pulse-glow`,children:`● PLAYING`}):t?`■ STOPPED`:`LOAD SAMPLE`}),a&&(0,$.jsxs)(`div`,{style:{fontSize:`8px`,color:`#FF2D9B`,letterSpacing:`0.1em`,marginTop:`2px`},children:[(0,$.jsx)(`span`,{className:`rec-pulse`,style:{display:`inline-block`,width:6,height:6,borderRadius:`50%`,background:`#FF2D9B`,marginRight:4}}),`REC`]})]}),(0,$.jsx)(`button`,{onClick:c,disabled:!e,title:a?`Stop recording & download`:`Start recording`,style:{width:`32px`,height:`32px`,borderRadius:`50%`,border:`2px solid ${a?`#FF2D9B`:`rgba(136,136,160,0.35)`}`,background:a?`#FF2D9B22`:`rgba(80,80,94,0.3)`,cursor:e?`pointer`:`not-allowed`,display:`flex`,alignItems:`center`,justifyContent:`center`,opacity:e?1:.35,transition:`all 0.2s`,flexShrink:0},className:a?`rec-pulse`:``,children:(0,$.jsx)(`div`,{style:{width:10,height:10,borderRadius:a?`2px`:`50%`,background:a?`#FF2D9B`:`rgba(255,45,155,0.6)`,transition:`border-radius 0.2s`}})}),(0,$.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`6px`},children:[(0,$.jsx)(`span`,{style:{fontSize:`9px`,fontWeight:`700`,letterSpacing:`0.1em`,color:`#FFE629`,textShadow:`0 0 6px #FFE62988`,textTransform:`uppercase`},children:`VOL`}),(0,$.jsx)(`input`,{type:`range`,min:`0`,max:`1`,step:`0.01`,value:n,onChange:l,style:{width:`60px`,WebkitAppearance:`none`,appearance:`none`,height:`4px`,borderRadius:`2px`,background:`linear-gradient(to right, #FFE629 ${n*100}%, rgba(136,136,160,0.2) ${n*100}%)`,outline:`none`,cursor:`pointer`}}),(0,$.jsxs)(`span`,{style:{fontSize:`9px`,color:`rgba(192,192,204,0.7)`,minWidth:`26px`},children:[Math.round(n*100),`%`]})]})]})})}function qu(){let e=(0,_.useRef)(null),t=(0,_.useRef)(0),n=w(e=>e.audioLoaded),r=w(e=>e.nodes),i=(0,_.useCallback)(()=>{let n=e.current;if(!n)return;let a=n.getContext(`2d`);if(!a)return;let{width:o,height:s}=n;a.clearRect(0,0,o,s);let c=Cu.buffer;if(!c){a.fillStyle=`rgba(136, 136, 153, 0.35)`,a.font=`700 10px "Courier New", monospace`,a.letterSpacing=`0.15em`,a.textAlign=`center`,a.textBaseline=`middle`,a.fillText(`DROP A SAMPLE`,o/2,s/2);return}let l=c.numberOfChannels,u=c.length,d=Math.ceil(u/o);a.beginPath(),a.strokeStyle=`#888899`,a.lineWidth=1;for(let e=0;e<o;e++){let t=1,n=-1;for(let r=0;r<d;r++){let i=0;for(let t=0;t<l;t++)i+=c.getChannelData(t)[e*d+r]??0;let a=i/l;a<t&&(t=a),a>n&&(n=a)}let r=s/2,i=(1+t)*r,o=(1+n)*r;e===0?a.moveTo(e,i):(a.lineTo(e,i),a.lineTo(e,o))}if(a.stroke(),r.length>0)for(let e of r){let t=e.time/c.duration*o;a.beginPath(),a.arc(t,s/2,2.5,0,Math.PI*2),a.fillStyle=`#FFE629`,a.shadowColor=`#FFE629`,a.shadowBlur=6,a.fill(),a.shadowBlur=0}let f=Cu.position*o;a.beginPath(),a.moveTo(f,0),a.lineTo(f,s),a.strokeStyle=`#FF2D9B`,a.lineWidth=1.5,a.shadowColor=`#FF2D9B`,a.shadowBlur=8,a.stroke(),a.shadowBlur=0,t.current=requestAnimationFrame(i)},[r]);(0,_.useEffect)(()=>(t.current=requestAnimationFrame(i),()=>{t.current&&cancelAnimationFrame(t.current)}),[i]);let a=(0,_.useCallback)(t=>{let n=e.current;if(!n||!Cu.buffer)return;let r=n.getBoundingClientRect(),i=(t.clientX-r.left)/r.width;Cu.position=Math.max(0,Math.min(1,i))},[]);return(0,$.jsxs)(`div`,{className:`panel`,style:{padding:0},children:[(0,$.jsxs)(`div`,{className:`panel-header`,children:[(0,$.jsx)(`span`,{className:`sparkle`,children:`✦`}),` WAVEFORM `,(0,$.jsx)(`span`,{className:`sparkle`,style:{animationDelay:`0.8s`},children:`✧`})]}),(0,$.jsxs)(`div`,{style:{padding:`8px 10px 10px`},children:[(0,$.jsx)(`canvas`,{ref:e,width:240,height:60,onClick:a,style:{width:`100%`,height:`60px`,borderRadius:`6px`,background:`rgba(0,0,0,0.4)`,cursor:n?`crosshair`:`default`,display:`block`}}),n&&(0,$.jsx)(`div`,{style:{marginTop:`4px`,fontSize:`8px`,color:`rgba(136, 136, 153, 0.45)`,textAlign:`center`,letterSpacing:`0.08em`},children:`click to scrub position`})]})]})}var Ju=[{label:`LP`,value:`lowpass`},{label:`HP`,value:`highpass`},{label:`BP`,value:`bandpass`}];function Yu(){let e=w(e=>e.filterCutoff),t=w(e=>e.filterResonance),n=w(e=>e.filterType),r=w(e=>e.delayTime),i=w(e=>e.delayFeedback),a=w(e=>e.delayWet),o=w(e=>e.reverbWet),s=w(e=>e.setFilterCutoff),c=w(e=>e.setFilterResonance),l=w(e=>e.setFilterType),u=w(e=>e.setDelayTime),d=w(e=>e.setDelayFeedback),f=w(e=>e.setDelayWet),p=w(e=>e.setReverbWet),m=(0,_.useCallback)(e=>{s(e),Cu.setFilterCutoff(e)},[s]),h=(0,_.useCallback)(e=>{c(e),Cu.setFilterResonance(e)},[c]),g=(0,_.useCallback)(e=>{l(e),Cu.setFilterType(e)},[l]),v=(0,_.useCallback)(e=>{u(e),Cu.setDelayTime(e)},[u]),y=(0,_.useCallback)(e=>{d(e),Cu.setDelayFeedback(e)},[d]),b=(0,_.useCallback)(e=>{f(e),Cu.setDelayWet(e)},[f]),x=(0,_.useCallback)(e=>{p(e),Cu.setReverbWet(e)},[p]);return(0,$.jsxs)(`div`,{className:`panel`,children:[(0,$.jsxs)(`div`,{className:`panel-header`,style:{borderColor:`rgba(255, 230, 41, 0.4)`},children:[(0,$.jsx)(`span`,{className:`sparkle`,children:`⊛`}),` FX CHAIN`,` `,(0,$.jsx)(`span`,{style:{fontSize:`9px`,opacity:.5},children:`// filter · delay · reverb`})]}),(0,$.jsxs)(`div`,{style:{padding:`10px 12px`,display:`flex`,flexDirection:`column`,gap:`10px`},children:[(0,$.jsxs)(`div`,{style:{background:`rgba(255, 230, 41, 0.04)`,border:`1px solid rgba(255, 230, 41, 0.15)`,borderRadius:`10px`,padding:`8px`},children:[(0,$.jsx)(`div`,{style:{fontSize:`8px`,fontWeight:700,color:`#FFE629`,letterSpacing:`0.14em`,marginBottom:`8px`,opacity:.8},children:`FILTER`}),(0,$.jsx)(`div`,{style:{display:`flex`,gap:`4px`,marginBottom:`8px`},children:Ju.map(({label:e,value:t})=>(0,$.jsx)(`button`,{onClick:()=>g(t),style:{flex:1,padding:`4px 6px`,borderRadius:`7px`,border:`1px solid ${n===t?`#FFE629`:`rgba(255,255,255,0.1)`}`,background:n===t?`rgba(255, 230, 41, 0.18)`:`rgba(255,255,255,0.03)`,color:n===t?`#FFE629`:`rgba(255,255,255,0.35)`,fontSize:`9px`,fontWeight:700,letterSpacing:`0.06em`,cursor:`pointer`,transition:`all 0.15s`,boxShadow:n===t?`0 0 10px rgba(255,230,41,0.3)`:`none`},children:e},t))}),(0,$.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-around`},children:[(0,$.jsx)(Vu,{value:e,min:80,max:18e3,label:`CUTOFF`,color:`#FFE629`,onChange:m,defaultValue:8e3,formatValue:e=>e>=1e3?`${(e/1e3).toFixed(1)}k`:`${e.toFixed(0)}`}),(0,$.jsx)(Vu,{value:t,min:.1,max:20,label:`RESO`,color:`#FFE629`,onChange:h,defaultValue:1,formatValue:e=>e.toFixed(1)})]})]}),(0,$.jsxs)(`div`,{style:{background:`rgba(136, 136, 153, 0.04)`,border:`1px solid rgba(136, 136, 153, 0.15)`,borderRadius:`10px`,padding:`8px`},children:[(0,$.jsx)(`div`,{style:{fontSize:`8px`,fontWeight:700,color:`#888899`,letterSpacing:`0.14em`,marginBottom:`8px`,opacity:.8},children:`DELAY`}),(0,$.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-around`},children:[(0,$.jsx)(Vu,{value:r,min:0,max:2,label:`TIME`,color:`#888899`,onChange:v,defaultValue:.25,formatValue:e=>`${e.toFixed(2)}s`}),(0,$.jsx)(Vu,{value:i,min:0,max:.95,label:`FDBK`,color:`#888899`,onChange:y,defaultValue:.3,formatValue:e=>`${Math.round(e*100)}%`}),(0,$.jsx)(Vu,{value:a,min:0,max:1,label:`WET`,color:`#888899`,onChange:b,defaultValue:0,formatValue:e=>`${Math.round(e*100)}%`})]})]}),(0,$.jsxs)(`div`,{style:{background:`rgba(255, 45, 155, 0.04)`,border:`1px solid rgba(255, 45, 155, 0.15)`,borderRadius:`10px`,padding:`8px`},children:[(0,$.jsx)(`div`,{style:{fontSize:`8px`,fontWeight:700,color:`#FF2D9B`,letterSpacing:`0.14em`,marginBottom:`8px`,opacity:.8},children:`REVERB`}),(0,$.jsx)(`div`,{style:{display:`flex`,justifyContent:`center`},children:(0,$.jsx)(Vu,{value:o,min:0,max:1,label:`WET`,color:`#FF2D9B`,onChange:x,defaultValue:0,formatValue:e=>`${Math.round(e*100)}%`})})]})]})]})}var Xu=Object.keys(xu);function Zu(){let e=w(e=>e.harmonizerEnabled),t=w(e=>e.harmonizerChordMode),n=w(e=>e.harmonizerVoiceGain),r=w(e=>e.harmonizerDetune),i=w(e=>e.detectedKey),a=w(e=>e.detectedKeyConfidence),o=w(e=>e.setHarmonizerEnabled),s=w(e=>e.setHarmonizerChordMode),c=w(e=>e.setHarmonizerVoiceGain),l=w(e=>e.setHarmonizerDetune),u=(0,_.useCallback)(()=>{let t=!e;o(t),Su.enabled=t,t?Su.start():Su.stop()},[e,o]),d=(0,_.useCallback)(e=>{s(e),Su.setChordMode(e)},[s]),f=(0,_.useCallback)(e=>{c(e),Su.setVoiceGain(e)},[c]),p=(0,_.useCallback)(e=>{l(e),Su.setDetune(e)},[l]),m=Math.round(a*100);return(0,$.jsxs)(`div`,{className:`panel`,children:[(0,$.jsxs)(`div`,{className:`panel-header`,style:{borderColor:`rgba(255, 230, 41, 0.4)`},children:[(0,$.jsx)(`span`,{className:`sparkle`,children:`✦`}),` HARMONIZER`,` `,(0,$.jsx)(`span`,{style:{fontSize:`9px`,opacity:.5},children:`// chord voices`})]}),(0,$.jsxs)(`div`,{style:{padding:`10px 12px`,display:`flex`,flexDirection:`column`,gap:`10px`},children:[(0,$.jsx)(`button`,{onClick:u,style:{width:`100%`,padding:`8px 12px`,borderRadius:`10px`,border:`1px solid ${e?`#FFE629`:`rgba(255,255,255,0.15)`}`,background:e?`rgba(255, 230, 41, 0.12)`:`rgba(255,255,255,0.04)`,color:e?`#FFE629`:`rgba(255,255,255,0.35)`,fontSize:`10px`,fontWeight:800,letterSpacing:`0.15em`,cursor:`pointer`,transition:`all 0.15s`,boxShadow:e?`0 0 16px rgba(255,230,41,0.3)`:`none`,textTransform:`uppercase`},children:e?`✦ HARMONIZER ON ✦`:`○ HARMONIZER OFF`}),(0,$.jsxs)(`div`,{style:{background:`rgba(255, 230, 41, 0.03)`,border:`1px solid rgba(255, 230, 41, 0.12)`,borderRadius:`10px`,padding:`8px`},children:[(0,$.jsx)(`div`,{style:{fontSize:`8px`,fontWeight:700,color:`#FFE629`,letterSpacing:`0.14em`,marginBottom:`6px`,opacity:.7},children:`CHORD MODE`}),(0,$.jsx)(`div`,{style:{display:`grid`,gridTemplateColumns:`repeat(4, 1fr)`,gap:`4px`},children:Xu.map(e=>(0,$.jsx)(`button`,{onClick:()=>d(e),style:{padding:`5px 2px`,borderRadius:`7px`,border:`1px solid ${t===e?`#FFE629`:`rgba(255,255,255,0.1)`}`,background:t===e?`rgba(255,230,41,0.18)`:`rgba(255,255,255,0.03)`,color:t===e?`#FFE629`:`rgba(255,255,255,0.35)`,fontSize:`8px`,fontWeight:700,letterSpacing:`0.04em`,cursor:`pointer`,transition:`all 0.15s`,boxShadow:t===e?`0 0 8px rgba(255,230,41,0.25)`:`none`},children:e},e))})]}),(0,$.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-around`},children:[(0,$.jsx)(Vu,{value:n,min:0,max:1,label:`V.GAIN`,color:`#FFE629`,onChange:f,defaultValue:.35,formatValue:e=>`${Math.round(e*100)}%`}),(0,$.jsx)(Vu,{value:r,min:0,max:50,label:`DETUNE`,color:`#FFE629`,onChange:p,defaultValue:8,formatValue:e=>`${e.toFixed(0)}c`})]}),i?(0,$.jsxs)(`div`,{style:{background:`rgba(255, 230, 41, 0.06)`,border:`1px solid rgba(255, 230, 41, 0.2)`,borderRadius:`10px`,padding:`8px 10px`},children:[(0,$.jsxs)(`div`,{style:{display:`flex`,justifyContent:`space-between`,alignItems:`center`,marginBottom:`5px`},children:[(0,$.jsx)(`div`,{style:{fontSize:`11px`,fontWeight:800,color:`#FFE629`,letterSpacing:`0.1em`,textShadow:`0 0 10px #FFE629`},children:i}),(0,$.jsxs)(`div`,{style:{fontSize:`9px`,color:`rgba(255, 230, 41, 0.7)`,fontVariantNumeric:`tabular-nums`},children:[m,`%`]})]}),(0,$.jsx)(`div`,{style:{height:`3px`,borderRadius:`2px`,background:`rgba(255,255,255,0.08)`,overflow:`hidden`},children:(0,$.jsx)(`div`,{style:{height:`100%`,width:`${m}%`,background:`linear-gradient(90deg, #FFE629, #888899)`,boxShadow:`0 0 6px #FFE629`,transition:`width 0.5s ease`}})})]}):(0,$.jsx)(`div`,{style:{background:`rgba(0,0,0,0.2)`,border:`1px solid rgba(255,255,255,0.06)`,borderRadius:`10px`,padding:`8px 10px`,textAlign:`center`,fontSize:`8px`,color:`rgba(255,255,255,0.2)`,letterSpacing:`0.1em`},children:`load a sample to detect key`})]})]})}function Qu(){return(0,$.jsxs)(`div`,{style:{position:`relative`,width:`100vw`,height:`100vh`,overflow:`hidden`,background:`#28282F`},children:[(0,$.jsx)(Tu,{}),(0,$.jsxs)(`div`,{style:{position:`absolute`,inset:0,pointerEvents:`none`,display:`flex`,flexDirection:`column`,padding:`16px`,gap:`10px`},children:[(0,$.jsxs)(`header`,{style:{pointerEvents:`auto`,display:`flex`,alignItems:`center`,justifyContent:`space-between`},children:[(0,$.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`10px`},children:[(0,$.jsx)(`span`,{className:`sparkle`,style:{color:`#FF2D9B`,fontSize:`20px`},children:`✦`}),(0,$.jsx)(`h1`,{style:{margin:0,fontSize:`22px`,fontWeight:`900`,letterSpacing:`0.2em`,textTransform:`uppercase`,background:`linear-gradient(90deg, #FF2D9B, #888899, #FFE629)`,WebkitBackgroundClip:`text`,WebkitTextFillColor:`transparent`,backgroundClip:`text`,filter:`drop-shadow(0 0 12px #888899)`},children:`GrainWeaver`}),(0,$.jsx)(`span`,{className:`sparkle`,style:{color:`#FFE629`,fontSize:`16px`,animationDelay:`0.7s`},children:`✧`})]}),(0,$.jsx)(`div`,{style:{fontSize:`9px`,fontWeight:`700`,letterSpacing:`0.15em`,color:`rgba(136, 136, 153, 0.5)`,textTransform:`uppercase`},children:`Granular Synthesizer`})]}),(0,$.jsxs)(`div`,{style:{flex:1,display:`flex`,flexDirection:`row`,gap:`10px`,alignItems:`flex-start`},children:[(0,$.jsxs)(`div`,{style:{pointerEvents:`auto`,display:`flex`,flexDirection:`column`,gap:`10px`,width:`260px`,flexShrink:0,overflowY:`auto`,maxHeight:`calc(100vh - 120px)`,paddingRight:`2px`},children:[(0,$.jsx)(Mu,{}),(0,$.jsx)(qu,{}),(0,$.jsx)(Yu,{}),(0,$.jsx)(Zu,{}),(0,$.jsx)(Gu,{}),(0,$.jsx)(Hu,{})]}),(0,$.jsx)(`div`,{style:{flex:1}}),(0,$.jsx)(`div`,{style:{pointerEvents:`auto`,display:`flex`,flexDirection:`column`,gap:`10px`,width:`180px`,flexShrink:0},children:(0,$.jsx)($u,{})})]}),(0,$.jsx)(`div`,{style:{pointerEvents:`auto`,width:`260px`},children:(0,$.jsx)(Ku,{})})]})]})}function $u(){return(0,$.jsxs)(`div`,{className:`panel`,style:{padding:`0`},children:[(0,$.jsxs)(`div`,{className:`panel-header`,children:[(0,$.jsx)(`span`,{className:`sparkle`,children:`✦`}),` INFO `,(0,$.jsx)(`span`,{className:`sparkle`,style:{animationDelay:`1.2s`},children:`★`})]}),(0,$.jsxs)(`div`,{style:{padding:`12px`,fontSize:`10px`,color:`rgba(136, 136, 153, 0.7)`,lineHeight:`1.6`},children:[(0,$.jsx)(`div`,{style:{marginBottom:`8px`,color:`#FFE629`,fontWeight:`700`,letterSpacing:`0.1em`},children:`LORENZ ATTRACTOR`}),(0,$.jsx)(`div`,{style:{color:`rgba(255,240,255,0.5)`},children:`σ = 10 · ρ = 28 · β = 8/3`}),(0,$.jsx)(`div`,{style:{marginTop:`8px`,color:`#FF2D9B`,fontWeight:`600`},children:`dx/dt = σ(y−x)`}),(0,$.jsx)(`div`,{style:{color:`#888899`,fontWeight:`600`},children:`dy/dt = x(ρ−z)−y`}),(0,$.jsx)(`div`,{style:{color:`#FFE629`,fontWeight:`600`},children:`dz/dt = xy − βz`}),(0,$.jsx)(`div`,{style:{marginTop:`12px`,padding:`8px`,borderRadius:`8px`,background:`rgba(255, 45, 155, 0.06)`,border:`1px solid rgba(255, 45, 155, 0.2)`,color:`rgba(255,240,255,0.5)`,fontSize:`9px`,letterSpacing:`0.05em`},children:`Drop an audio sample to seed grain nodes. Hot pink sparkles = onset points. The agent orb traverses nodes in sync with playback.`}),(0,$.jsxs)(`div`,{style:{marginTop:`12px`},children:[(0,$.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`6px`,marginBottom:`4px`},children:[(0,$.jsx)(`div`,{style:{width:`8px`,height:`8px`,borderRadius:`50%`,background:`#FF2D9B`,boxShadow:`0 0 6px #FF2D9B`}}),(0,$.jsx)(`span`,{style:{color:`rgba(255,240,255,0.6)`,fontSize:`9px`},children:`Pink — hot pink trail`})]}),(0,$.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`6px`,marginBottom:`4px`},children:[(0,$.jsx)(`div`,{style:{width:`8px`,height:`8px`,borderRadius:`50%`,background:`#888899`,boxShadow:`0 0 6px #888899`}}),(0,$.jsx)(`span`,{style:{color:`rgba(255,240,255,0.6)`,fontSize:`9px`},children:`Purple — attractor arms`})]}),(0,$.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:`6px`},children:[(0,$.jsx)(`div`,{style:{width:`8px`,height:`8px`,borderRadius:`50%`,background:`#FFE629`,boxShadow:`0 0 6px #FFE629`}}),(0,$.jsx)(`span`,{style:{color:`rgba(255,240,255,0.6)`,fontSize:`9px`},children:`Cyan — crossing paths`})]})]})]})]})}(0,v.createRoot)(document.getElementById(`root`)).render((0,$.jsx)(_.StrictMode,{children:(0,$.jsx)(Qu,{})}));